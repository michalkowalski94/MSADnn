...
def _main():
    ...
    input_shape = (1760,1760) # multiple of 32, hw
    ...
    if True:
        #try:
        #    model_ = multi_gpu_model(model,gpus=2,cpu_merge=False)
        ...
        #    multi = False
        model.compile(optimizer=Adam(lr=1e-8), loss={
            # use custom yolo_loss Lambda layer.
            'yolo_loss': lambda y_true, y_pred: y_pred})
        model.load_weights("model_data/1760weights.h5")
        batch_size = 1
        ...
        #else:
        #    model_.save_weights(log_dir + 'trained_weights_stage_1.h5')
